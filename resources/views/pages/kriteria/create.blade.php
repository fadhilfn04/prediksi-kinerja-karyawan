    ...
    <div class="card shadow-sm">
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <h3 class="fw-bold mb-0">Form Tambah Kriteria</h3>
            </div>
        </div>

        <div class="card-body pt-0">
            <form action="{{ route('kriteria.store') }}" method="POST" class="form">
                @csrf
                ...
                <div class="row g-6 mb-8">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" name="nama_kriteria" id="nama_kriteria" class="form-control form-control-solid @error('nama_kriteria') is-invalid @enderror" placeholder="Masukkan Nama Kriteria" value="{{ old('nama_kriteria') }}" required />
                        @error('nama_kriteria')
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="number" step="0.01" name="bobot" id="bobot" class="form-control form-control-solid @error('bobot') is-invalid @enderror" placeholder="Masukkan Bobot" value="{{ old('bobot') }}" required />
                        @error('bobot')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>

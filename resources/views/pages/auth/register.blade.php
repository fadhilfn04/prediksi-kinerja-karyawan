<x-auth-layout>
    ...
    <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="{{ route('login') }}" action="{{ route('register') }}">
        ...
        <div class="fv-row mb-8" data-kt-password-meter="true">
            ...
            <div class="mb-1">
                ...
                <div class="position-relative mb-3">
                    <input class="form-control bg-transparent" type="password" placeholder="PIN" name="password" autocomplete="off"/>
        ...
        <div class="fv-row mb-8">
            ...
            <input placeholder="Ulangi PIN" name="password_confirmation" type="password" autocomplete="off" class="form-control bg-transparent"/>
            <!--end::Repeat Password-->
        </div>
        <!--end::Input group--->
        ...
        <div class="fv-row mb-10">
            <div class="form-check form-check-custom form-check-solid form-check-inline">
                ...
                <label class="form-check-label fw-semibold text-gray-700 fs-6">
                    ...
                    <a href="#" class="ms-1 link-primary">Syarat dan Ketentuan</a>.
                </label>
            </div>
        </div>
        <!--end::Input group--->
